...
denomPrime = X.dot(X) - X.mean() * X.mean()

a = ( X.dot(Y) - Y.mean()*X.sum() ) / denominator
aPrime = ( X.dot(Y) - Y.mean()*X.mean() ) / denomPrime

b = ( Y.mean() * X.dot(X) - X.mean() * X.dot(Y) ) / denominator
bPrime = ( Y.mean() * X.dot(X) - X.mean() * X.dot(Y) ) / denomPrime

print(str(a)+" a")
print(str(aPrime)+" aPrime")
print(str(b)+" b")
print(str(bPrime)+" bPrime")
